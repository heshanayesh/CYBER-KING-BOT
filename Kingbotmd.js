...
module.exports = KingmdWH = async (KingmdWH, m, chatUpdate, store) => {
	...
	//group target \\
const reply = (teks) => {
            KingmdWH.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botname}`,"body": ` [🕊️𝙲𝚈𝙱𝙴𝚁-𝙺𝙸𝙽𝙶-𝙱𝙾𝚃🕊️]`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./KINGMedia/logo.jpeg`),"sourceUrl": "https://i.ibb.co/YLN5KND/20220711-130334.jpg"}}}, { quoted: m})
        }
        
        const replay = (teks) => {
            KingmdWH.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botname}`,"body": ` [🕊️𝙲𝚈𝙱𝙴𝚁-𝙺𝙸𝙽𝙶-𝙱𝙾𝚃🕊️]`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./KINGMedia/logo.jpeg`),"sourceUrl": "https://chat.whatsapp.com/Fz2YrAhn3yL6WQNlRqX6Pi"}}}, { quoted: m})
        }
...
🔗 *Media Url* : ${images}`,
	    ...
	    case 'play': case 'ytplay': {
                ...
                let buttons = [
                    ...
                    {buttonId: `ytmp4 ${anu.url}`, buttonText: {displayText: '📽️Video'}, type: 1}
                ]
                let buttonMessage = {
            ...
            case 'owner': case 'creator': {
				...
				case 'waifu': case 'loli':
                    ...
                    case 'bug': case 'report': {
                    	...
                    	KingmdWH.sendMessage(`94784997828@s.whatsapp.net`, {text: `*Bug Report From:* wa.me/${m.sender.split("@")[0]}
Report Message: ${text}` })
...
📌 ɪ ᴀᴍ *🕊️𝙲𝚈𝙱𝙴𝚁-𝙺𝙸𝙽𝙶-𝙱𝙾𝚃🕊️* ᴡʜᴀᴛꜱᴀᴘᴘ ᴜꜱᴇʀ ʙᴏᴛ V1.0.0
📌 ʙᴏᴛ ɪꜱ ᴅᴇᴠᴇʟᴏᴘᴇᴅ ʙʏ ᴄʏʙᴇʀ ᴋɪɴɢ.


   🔥 ᴛʜᴀɴᴋ ʏᴏᴜ ꜰᴏʀ ᴜꜱɪɴɢ ᴄʏʙᴇʀ ᴋɪɴɢ ʙᴏᴛ 🔥
      ...
      🔰 ꜰᴏʀ 24/7 ʜᴇʟᴘ ᴍꜱɢ ᴍᴇ 🔰`
           ...
           let buttons = [
               ...
               {buttonId: `kingbotinfo`, buttonText: {displayText: '🎲 BOT INFO'}, type: 1},
                ]
...
┌────────────────❖
│👋 ʜɪ ${pushname},
│✦ ɪ ᴀᴍ [🕊️𝙲𝚈𝙱𝙴𝚁-𝙺𝙸𝙽𝙶-𝙱𝙾𝚃🕊️] 🔥
│᪣ ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴄʏʙᴇʀ ᴋɪɴɢ
├────────────────❖
│        *「 BOT INFO 」*
│
...
THIS IS [🕊️𝙲𝚈𝙱𝙴𝚁-𝙺𝙸𝙽𝙶-𝙱𝙾𝚃🕊️] CMD MENU`
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
           ...
           case 'verify': {
	         	...
	         	reply('[🕊️𝙲𝚈𝙱𝙴𝚁-𝙺𝙸𝙽𝙶-𝙱𝙾𝚃🕊️] CONFERMED 2022 |>')
	         	}
	         	
	       break 
	       case 'joinsupportgroup': {
	       
	       let result = `https://chat.whatsapp.com/Kh9IbQ8LvyZ4Md2BKquvUZ`
                await KingmdWH.groupAcceptInvite(result).then((res) => reply(jsonformat(res))).catch((err) => reply(jsonformat(err)))
                replay('දැන් [🕊️𝙲𝚈𝙱𝙴𝚁-𝙺𝙸𝙽𝙶-𝙱𝙾𝚃🕊️] official support group එකට join වෙයි...')
	                            }
                      break
                case 'command': {
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                listMessage :{
                    title: `┏━━━━━━━━━━━━━━━━━`,
                    description: `┣👋ʜɪ ᴅᴇᴀʀ ${pushname},\n┃\n┣ 𝙸 𝙰𝙼 [🕊️𝙲𝚈𝙱𝙴𝚁-𝙺𝙸𝙽𝙶-𝙱𝙾𝚃🕊️]\n┣🎭𝙰 𝚆𝙷𝙰𝚃𝚂𝙰𝙿𝙿 𝚄𝚂𝙴𝚁 𝙱𝙾𝚃🎭\!┃\n┣ 🍁ᴄʜᴏᴏꜱᴇ ᴛʜᴇ ᴍᴇɴᴜ🍁\n┗━━━━━━━━━━━━━━━━━\n\n*🎲 THIS IS [🕊️𝙲𝚈𝙱𝙴𝚁-𝙺𝙸𝙽𝙶-𝙱𝙾𝚃🕊️] MENU LIST*\n`,
                    buttonText: "ᴛᴀᴘ ʜᴇʀᴇ ᴛᴏ ꜱᴇʟᴇᴄᴛ ᴍᴇɴᴜ",
                    footerText: 'ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴄʏʙᴇʀ ᴋɪɴɢ ᴍᴜʟᴛɪ-ᴅᴇᴠɪᴄᴇ ʙᴏᴛ',
                    ...
                    sections: [{
							...
							{
								"title": "DEPLOY CYBER KING BOT",
								"rows": [
									{
										"title": "DEPLOY CYBER KING BOT",
										"description": "Displays The Github link for deploy SHEWON-MD-BOT",
										"rowId": `${prefix}git`
									}
								]
							},
...
Kingbotehimenu = `🔥𝘾𝙔𝘽𝙀𝙍 𝙆𝙄𝙉𝙂 ᏴϴͲ ᎬᎻᏆ ᏟϴᏞᏞᎬᏟͲᏆϴΝ🔥

🛑 ᴘᴏᴡᴇʀᴇᴅ ʙʏ :: 𝘾𝙔𝘽𝙀𝙍 𝙆𝙄𝙉𝙂 οƒƒιϲιαℓ τєαм
...
◈ ᴇʜɪ ᴅᴇᴠᴇʟᴏᴘᴇᴅ ʙʏ → 𝘾𝙔𝘽𝙀𝙍 𝙆𝙄𝙉𝙂


🔥 ᏢᎾᎳᎬᏒᎬᎠ bᎽ [🕊️𝙲𝚈𝙱𝙴𝚁-𝙺𝙸𝙽𝙶🕊️] 🔥`

        let buttons = [
             {buttonId: `kingehiuse`, buttonText: {displayText: '🕹️ ️HOW TO USE'}, type: 1},
...
kingbotehiapkmenu = `🔥𝘾𝙔𝘽𝙀𝙍 𝙆𝙄𝙉𝙂 ᏴϴͲ ᎬᎻᏆ ᎪᏢᏦ ᏟϴᏞᏞᎬᏟͲᏆϴΝ🔥

🛑 ᴘᴏᴡᴇʀᴇᴅ ʙʏ :::  [🕊️𝙲𝚈𝙱𝙴𝚁-𝙺𝙸𝙽𝙶🕊️]™
...
Kingbotgitlink=`*[🕊️𝙲𝚈𝙱𝙴𝚁-𝙺𝙸𝙽𝙶-𝙱𝙾𝚃🕊️] created by 𝘾𝙔𝘽𝙀𝙍 𝙆𝙄𝙉𝙂*\n\n*❑ Contact Owner : https://wa.me/94784997828?text=HI......%20𝘾𝙔𝘽𝙀𝙍_𝙆𝙄𝙉𝙂%20𝛃𝚯𝚪%20OWNER࿐*\n\n*❑ Github link → https://github.com/CyberKing4/CYBER-KING-BOT*\n\n*❑ My channel link : https://youtube.com/channel/UCRt-7UDMMcfjunuZwZi481Q*\n\n*🔰 For More Updates Subscribe The Channel 🔰*`


let buttons = [
               {buttonId: `shortmenu`, buttonText: {displayText: '📝 SHORT MENU'}, type: 1},
               {buttonId: `kingbotinfo`, buttonText: {displayText: '🎲 ️BOT INFO'}, type: 1},
               {buttonId: `ping`, buttonText: {displayText: '💻 SYSTEM STATUS'}, type: 1}
                ]
                let buttonMessage = {
                    image: fs.readFileSync('./src/bot.jpg'),
...
await KingmdWH.send5ButImg(from, `` + '' + ' ', `
Thanks to (white-hackers)
white-hacker (For helping me to deploy qr in replit and answered my every doubts regard this project)
