...
async function startKingmdWH() {
    const KingmdWH = NexusNwIncConnect({
        ...
        browser: ['CYBER-KING-MD-BOT\CYBER KING','Safari','1.0.0'],
        auth: state
    })
    ...
    // Get Profile Picture Group
       ...
       KingmdWH.send5ButImg(pea[0].id, `「 Group Settings Changed 」\n\nThe Group Has Been Closed By Admin, Now Only Admin Can Send Messages !`, `ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴄʏʙᴇʀ ᴋɪɴɢ`, wm_fatih, [])
       } else if(pea[0].announce == false) {
       KingmdWH.send5ButImg(pea[0].id, `「 Group Settings Changed 」\n\nThe Group Has Been Opened By Admin, Now Participants Can Send Messages !`, `ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴄʏʙᴇʀ ᴋɪɴɢ`, wm_fatih, [])
       } else if (pea[0].restrict == true) {
       KingmdWH.send5ButImg(pea[0].id, `「 Group Settings Changed 」\n\nGroup Info Has Been Restricted, Now Only Admin Can Edit Group Info !`, `ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴄʏʙᴇʀ ᴋɪɴɢ`, wm_fatih, [])
       } else if (pea[0].restrict == false) {
       KingmdWH.send5ButImg(pea[0].id, `「 Group Settings Changed 」\n\nGroup Info Has Been Opened, Now Participants Can Edit Group Info !`, `ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴄʏʙᴇʀ ᴋɪɴɢ`, wm_fatih, [])
       } else {
       KingmdWH.send5ButImg(pea[0].id, `「 Group Settings Changed 」\n\nGroup Subject Has Been Changed To *${pea[0].subject}*`, `ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴄʏʙᴇʀ ᴋɪɴɢ`, wm_fatih, [])
     }
    })
